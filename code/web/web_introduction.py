...
#举个例子，当你使用浏览器访问新浪网时，你的计算机就和新浪的某台服务器
#通过互联网连接起来了，然后，新浪的服务器把网页内容作为数据通过互联网
#传输到你的电脑上。


#更确切地说，网络通信是两台计算机上的两个 <进程> 之间的通信
#比如，浏览器进程和新浪服务器上的某个Web服务<进程>在通信
#而QQ进程是和腾讯的某个服务器上的某个<进程>在通信。
...
#如果一台计算机同时接入到两个或更多的网络，比如路由器，
#它就会有两个或多个IP地址，所以，IP地址对应的实际上是计算机的网络接口，
#通常是网卡。
